...
CRYPTOPP_NAKED state void CRYPTOPP_FASTCALL SHA512_SSE2_Transform(word64 *state, const word64 *data)
{
#ifdef __GNUC__
	...
	AS1(	push	eax)
	AS2(	xor		eax, eax)
	AS2(	lea 	edi, [esp+4+8*8])
	AS2(	lea 	esi, [esp+4+20*8+8])
...
#define SSE2_s1(r,a,b,c)\
	...
	AS2(	pxor	r, xmm7)		
	ASL(SHA512_Round)
	AS2(	paddq	mm0, [edi+7*8])
	AS2(	movq	mm2, [edi+5*8])
	AS2(	movq	mm3, [edi+6*8])
	AS2(	pxor	mm2, mm3)
	AS2(	pand 	mm2, mm5)
	...
	AS2(	paddq	mm0, mm2)
	AS2(	paddq	mm5, mm0)
	AS2(	movq	mm2, [edi+1*8])
	AS2(	movq	mm1, mm2)
	AS2(	por 	mm2, mm4)
	AS2(	pand 	mm2, [edi+2*8])
	AS2(	pand 	mm1, mm4)
	AS2(	por 	mm1, mm2)
	AS2(	paddq	mm1, mm5)
	AS2(	paddq	mm5, [edi+3*8])
	AS2(	movq	[edi+3*8], mm5)
	AS2(	movq	[edi+11*8], mm5)
	SSE2_S0_S1(mm4, 28, 34, 39)
	AS2(	paddq	mm4, mm1)
	AS2(	movq	[edi-8],mm4)
